...
#include "bat/ledger/internal/server/api/api_util.h"
...
ledger::Result GetParameters::CheckResponse(
...
void GetParameters::CreateRequest(GetParametersCallback callback) {
...
void GetParameters::OnRequest(
  ...
  ledger::RewardsParameters parameters;
  ledger::Result result = CheckResponse(response);
